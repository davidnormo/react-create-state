...
import { removeItem, toggleItem, updateItem } from "../reducer";

export const Item = memo(function Item({ todo }) {
        ...
        <li className={classnames({ completed: todo.completed })} data-testid="todo-item">
            <div className="view">
                {isWritable ? (
                    ...
                    <>
                        <input className="toggle" type="checkbox" data-testid="todo-item-toggle" checked={completed} onChange={() => toggleItem(id)} />
